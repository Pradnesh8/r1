...
import { addComment, postComment, fetchDishes, fetchComments, fetchPromos, fetchLeaders, addFeedback, postFeedback } from '../redux/ActionCreators';
...
const mapDispatchToProps = dispatch => ({
  ...
  addFeedback: (firstname,lastname,telnum,email,agree,contactType,message,date) => dispatch(addFeedback(firstname,lastname,telnum,email,agree,contactType,message,date)),
